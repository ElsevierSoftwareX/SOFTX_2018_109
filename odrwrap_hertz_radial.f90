      ...
      subroutine odr_wrap_hertz_radial( n,m,np,nq,x,y,beta, ifix, &
...
!                    covariance(2,3)/stdev_beta(2)/stdev_beta(3)
      ...
      real(kind=r8) function fun(x,a,hp,b)

      implicit none
      real(kind=r8), intent(in) :: x,a,hp,b
      real(kind=r8) :: w
      ...
      real(kind=r8) function dfun_da(x,a,hp,b)
      ...
      real(kind=r8) function dfun_db(x,a,hp,b)
      ...
      real(kind=r8) function dfun_dhp(x,a,hp,b)
      ...
      dfun_dhp = -0.5*(3+4*b*w)*a*w 

      end function dfun_dhp



      real(kind=r8) function dfun_ddeltai(x,a,hp,b)
      ...
      if (mod(ideval/10,10) .ge. 1) then
              do l=1,nq
                 do i=1,n
                     ...
                     fjacb(i,3,l) = dfun_db(xplusd(i,l), beta(1),beta(2), beta(3))
                 end do
              end do    
      end if         
      ...
      end subroutine odr_wrap_hertz_radial
